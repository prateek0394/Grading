...
if(submitData(finalData,'/grade/marks')){
...
finalData = {'id':id,'tabname':tabname,'data':dataDict,'midsemGrade':document.getElementById('1midsemGrade'+id).value,'endsemGrade':document.getElementById('endsemGrade'+id).value};
if(submitData(finalData,'/grade/marks')){
  closeEdit(id,tn,1,x);
if(tn=='1'){
